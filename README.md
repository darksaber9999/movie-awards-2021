# Awards 2021 Ballot Challenge

This is my submission for the Devslopes Interview Meta Front End Engineering Challenge.

In order to run this app after forking or cloning this repository, you will need to run the commands:
...
These commands are necessary to install the dependencies of the project, start the backend API, and finally run the project locally.

-- Previous Instructions --

# Front End Engineering Challenge

Welcome Candidate and thank you for taking the time to complete the take-home challenge.
